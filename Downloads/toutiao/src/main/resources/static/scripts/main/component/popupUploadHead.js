 ...
 */
(function (window) {
    var PopupUploadHead = Base.createClass('main.component.PopupUploadHead');
    ...
    Base.mix(PopupUploadHead, Component, {
        _tpl: [
            '<div>',
    ...
    function fInitialize(oConf) {
        ...
        PopupUploadHead.superClass.initialize.apply(that, arguments);
    }
