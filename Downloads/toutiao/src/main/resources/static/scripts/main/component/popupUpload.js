            ...
            '<div>',
              '<div class="form-group">',
                ...
                '</div>',
                  ...
                  '<div class="form-group"><label class="col-sm-2 control-label">内容</label><div class="col-sm-10"><textarea class="js-content form-control" rows="3"></textarea></div></div>',
                  '<div class="form-group">',
        ...
        listeners: [{
            ...
            handler: function () {
                ...
                $.ajax({
                    url: '/user/addNews/',
                    method: 'post',
                    data: {image: that.image, title: sTitle, link: sLink, content: sContent},
                    dataType: 'json'
